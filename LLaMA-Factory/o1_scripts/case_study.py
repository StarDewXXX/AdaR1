...
data_base = json.load(open("./data/model_generated/QwQ_math_test_8192_normal_K-1.json"))
data_pruned = json.load(open("./data/model_generated/QwQ-loft-iter0-alpha_5_math_test_8192_normal_K-1.json"))
