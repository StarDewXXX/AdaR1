...
n_gpus = args.n_gpus
max_tokens = args.max_tokens #max_solution_tokens_dict[model]
...
output_path = f"./data/model_generated/{model}_{dataset}_{max_tokens}_{speed}_K-{K}.json"#"./data/model_evaluation/
