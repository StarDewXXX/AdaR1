...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default=os.path.expanduser('./processed_data'),
    ...
    test_datasets = [TestDataset.AIME, TestDataset.AMC, TestDataset.MATH, TestDataset.MINERVA, TestDataset.OLYMPIAD_BENCH, TestDataset.AIME25, TestDataset.GPQA, TestDataset.MIX_MATHEMATIC_PROBLEMS, TestDataset.GSM8K, TestDataset.OMNIMATH, TestDataset.MATH_TRAIN, TestDataset.SCALER, TestDataset.AIME_100]
    ...
    for test_dataset, test_data_list in zip(test_datasets, test_datasets_data):
        ...
        print("test_dataset:",test_dataset,"test_data == TestDataset.GPQA:",test_dataset == TestDataset.GPQA)
        ...
        print(os.path.join(local_dir, f'{dataset_name}.parquet'))
